            ...
            <div class="card bg-secondary shadow">
                <div class="card-body">
                    <form autocomplete="off"
                        action="{{ route('siode.infodesa.wilayah-administratif.update', $wilayah_administratif) }}"
                        method="post">
                        @csrf @method('patch')
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama"
                                ...
                                value="{{ old('nama', $wilayah_administratif->nama) }}">
                            @error('nama')
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table-bordered table-hover table">
                            ...
                            <tbody>
                                @forelse ($wilayah_administratif->detailWilayahAdministratif as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-sm btn-danger hapus-data"
                                                ...
                                                data-action="{{ route('detailDusun.destroy', $item) }}"
                                                data-toggle="tooltip" title="Hapus" href="#modal-hapus"><i
    ...
    <div class="modal fade" id="modal-edit-detail-dusun" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered modal-" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{--  <form class="form form-edit" data-redirect="{{ route('dusun.edit', $dusun) }}" action=""
                        method="POST">
                        @csrf @method('patch')
