            ...
            <div class="card card-dark card-outline table-responsive">
                <div class="card-header">
                    <div class="card-title">
                        ...
                        <a href="{{ route('siode.buku.umum.peraturandesa.create') }}"
                    ...
                    <table id="example1"
                        ...
                        <thead>
                            <tr class="text-center">
                                ...
                                <th>Nomor Dan Tanggal Di Undangkan Dalam Lembaran Desa</th>
                                <th>Nomor Dan Tanggal Di Undangkan Dalam Berita Desa</th>
                                <th>Keterangan</th>
                            </tr>
                        </thead>
                        <tbody>
