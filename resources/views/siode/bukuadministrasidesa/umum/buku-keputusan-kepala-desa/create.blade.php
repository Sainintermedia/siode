        ...
        <form method="POST" action="{!! route('siode.buku.kearsipan.sarpras.sarprasstore') !!}" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="card-header">
                <div class="card-title">
                    <strong>INPUT DATA PERATURAN DESA</strong>
                </div>
            </div>
            <div class="card-body text-sm">
                <div class="bg-gray mt-2 mb-2 py-2 px-2">
                    <h6 class="mb-0">
                        <strong>PERDES :</strong>
                    </h6>
                </div>
                <div class="row">
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            <label for="">Nomor dan Tanggal Ditetapkan</label>
                            <input type="text" class="form-control form-control-sm text-sm"
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            <label for="">Tanggal Kesepakatan Peraturan Desa</label>
                            <input type="text" class="form-control form-control-sm text-sm"
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            <label for="">Nomor Dan Tanggal Di Undangkan Dalam Lembaran Desa</label>
                            <input type="text" class="form-control form-control-sm text-sm"
                                style="text-transform:uppercase" name="kondisi" id="" required>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            <label for="">Nomor Dan Tanggal Di Undangkan Dalam Berita Desa</label>
                            <input type="text" class="form-control form-control-sm text-sm"
                                style="text-transform:uppercase" name="kondisi" id="" required>
                        </div>
                    </div>
