            ...
            <div class="card card-dark card-outline table-responsive">
                <div class="card-header">
                    <div class="card-title">
                        <a href="{{ route('siode.buku.kearsipan.sarpras.sarprascreate') }}"
                    ...
                    <table id="example1"
                        ...
                        <tbody>
                            @forelse ($sarpras as $value => $fm)
                                <tr class="text-center">
                                    <td class="text-center">{{ $sarpras->firstItem() + $value }}</td>
                                    ...
                                    <td>{{ $fm->kode }}</td>
                                    <td>{{ $fm->sarpras }}</td>
                                    <td style="text-transform:uppercase">{{ $fm->jumlah }}</td>
                                    <td style="text-transform:uppercase" class="text-center">{{ $fm->lokasi }}</td>
                                    <td style="text-transform:uppercase" class="text-center">{{ $fm->kondisi }}</td>
                                </tr>
                            @empty
